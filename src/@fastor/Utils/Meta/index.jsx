...
export function Meta({ title, keywords, description, image, appName, url, domain }){
    return (
        <Head>
            ...
            <title>{`${title} | ${"John MacKenzi School"}`}</title>
...
Meta.defaultProps = {
    appName: 'John MacKenzi School',
    domain: 'johnmackenzieschool.com',
    url: 'https://johnmackenzieschool.com',
    title: 'JMS',
    description: 'Shop ergonomics, massage, smart home, solar, vr headsets and more at Discava Store.',
    image: 'https://jmackenzi.vercel.app/senior.webp',
}
